...
*BOT HW MODS V15*`, haikal.user.name, `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
haikal.sendListMsg(from, `
Game Menu🥳
*BOT HW MODS V15*`, haikal.user.name, `Silahkan Pilih Game Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'antilonk':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Antilink🥳
*BOT HW MODS V15*`, haikal.user.name, `Silahkan Pilih Antilink Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'welcomeee':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Welcome Menu🥳
*BOT HW MODS V15*`, haikal.user.name, `Silahkan Pilih Welcome Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'angtitox':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
 Anti Toxic🥳
 *BOT HW MODS V15*`, haikal.user.name, `Silahkan Pilih Toxic Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'downloadmenu': {
...
var video = generateWAMessageFromContent(from, proto.Message.fromObject({
	"videoMessage": {
					...
					"caption": `MODDED BY HW MODS WA - PUNYA NYALI GA BUAT TONTON VIDEO NYA ?`,
					"height": 720,
					"width": 1280,
